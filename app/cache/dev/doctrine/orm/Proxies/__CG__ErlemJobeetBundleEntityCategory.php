...
namespace Proxies\__CG__\Erlem\JobeetBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Erlem\JobeetBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'jobs', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'affiliates', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'active_jobs', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'more_jobs', '' . "\0" . 'Erlem\\JobeetBundle\\Entity\\Category' . "\0" . 'slug');
        }
