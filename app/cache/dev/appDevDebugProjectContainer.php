...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'erlem.jobeet.admin.affiliate' => 'getErlem_Jobeet_Admin_AffiliateService',
            'erlem.jobeet.admin.category' => 'getErlem_Jobeet_Admin_CategoryService',
            'erlem.jobeet.admin.job' => 'getErlem_Jobeet_Admin_JobService',
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Erlem/JobeetBundle/Resources/config/doctrine') => 'Erlem\\JobeetBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Erlem\\JobeetBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ErlemJobeetBundle' => 'Erlem\\JobeetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0de197a521dec780c253a63c5f1c64ea22b5cbd4f006fdc5105755255f69a2b0');
    ...
    /**
     * Gets the 'erlem.jobeet.admin.affiliate' service.
     *
     * @return \Erlem\JobeetBundle\Admin\AffiliateAdmin A Erlem\JobeetBundle\Admin\AffiliateAdmin instance.
     */
    protected function getErlem_Jobeet_Admin_AffiliateService()
    {
        $instance = new \Erlem\JobeetBundle\Admin\AffiliateAdmin('erlem.jobeet.admin.affiliate', 'Erlem\\JobeetBundle\\Entity\\Affiliate', 'ErlemJobeetBundle:AffiliateAdmin');
    ...
    /**
     * Gets the 'erlem.jobeet.admin.category' service.
     *
     * @return \Erlem\JobeetBundle\Admin\CategoryAdmin A Erlem\JobeetBundle\Admin\CategoryAdmin instance.
     */
    protected function getErlem_Jobeet_Admin_CategoryService()
    {
        $instance = new \Erlem\JobeetBundle\Admin\CategoryAdmin('erlem.jobeet.admin.category', 'Erlem\\JobeetBundle\\Entity\\Category', 'ErlemJobeetBundle:CategoryAdmin');
    ...
    /**
     * Gets the 'erlem.jobeet.admin.job' service.
     *
     * @return \Erlem\JobeetBundle\Admin\JobAdmin A Erlem\JobeetBundle\Admin\JobAdmin instance.
     */
    protected function getErlem_Jobeet_Admin_JobService()
    {
        $instance = new \Erlem\JobeetBundle\Admin\JobAdmin('erlem.jobeet.admin.job', 'Erlem\\JobeetBundle\\Entity\\Job', 'ErlemJobeetBundle:JobAdmin');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Erlem\\JobeetBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'erlem.jobeet.admin.category', 1 => 'erlem.jobeet.admin.job', 2 => 'erlem.jobeet.admin.affiliate'));
        $instance->setAdminGroups(array('jobeet' => array('label' => 'jobeet', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'erlem.jobeet.admin.category', 1 => 'erlem.jobeet.admin.job', 2 => 'erlem.jobeet.admin.affiliate'))));
        $instance->setAdminClasses(array('Erlem\\JobeetBundle\\Entity\\Category' => array(0 => 'erlem.jobeet.admin.category'), 'Erlem\\JobeetBundle\\Entity\\Job' => array(0 => 'erlem.jobeet.admin.job'), 'Erlem\\JobeetBundle\\Entity\\Affiliate' => array(0 => 'erlem.jobeet.admin.affiliate')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'erlem.jobeet.admin.category', 1 => 'erlem.jobeet.admin.job', 2 => 'erlem.jobeet.admin.affiliate'), $this);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Erlem/JobeetBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Erlem/JobeetBundle/Resources/views'), 'ErlemJobeet');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Erlem/JobeetBundle/Resources/config/validation.yml')));
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Erlem\\JobeetBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ErlemJobeetBundle' => 'Erlem\\JobeetBundle\\ErlemJobeetBundle',
            ...
            'sonata.core.form.types' => array(
                ...
                38 => 'sonata.admin.form.filter.type.number',
                39 => 'sonata.admin.form.filter.type.choice',
                40 => 'sonata.admin.form.filter.type.default',
                41 => 'sonata.admin.form.filter.type.date',
                42 => 'sonata.admin.form.filter.type.daterange',
                43 => 'sonata.admin.form.filter.type.datetime',
                44 => 'sonata.admin.form.filter.type.datetime_range',
                45 => 'sonata.core.form.type.array',
                46 => 'sonata.core.form.type.boolean',
                47 => 'sonata.core.form.type.collection',
                48 => 'sonata.core.form.type.translatable_choice',
                49 => 'sonata.core.form.type.date_range',
                50 => 'sonata.core.form.type.datetime_range',
                51 => 'sonata.core.form.type.date_picker',
                52 => 'sonata.core.form.type.datetime_picker',
                53 => 'sonata.core.form.type.date_range_picker',
                54 => 'sonata.core.form.type.datetime_range_picker',
                55 => 'sonata.core.form.type.equal',
                56 => 'sonata.core.form.type.color_selector',
                57 => 'sonata.block.form.type.block',
                58 => 'sonata.block.form.type.container_template',
            ),
